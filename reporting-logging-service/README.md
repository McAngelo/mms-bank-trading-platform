...
```
cd existing_repo
git remote add origin https://gitlab.turntabl.net/michael.johnson/reporting-logging-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.turntabl.net/michael.johnson/reporting-logging-service/-/settings/integrations)
