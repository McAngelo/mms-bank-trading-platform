...
public class ApiResponseUtil {
    ...
    public static <T> ApiResponse<T> toInternalServerErrorApiResponse(T data, String message, List<ErrorDetails> errors) {
        return toApiResponse(data, message, HttpStatus.INTERNAL_SERVER_ERROR.value(), errors);
    }

    public static <T> ApiResponse<T> toBadRequestApiResponse(T data, String message, List<ErrorDetails> errors) {
